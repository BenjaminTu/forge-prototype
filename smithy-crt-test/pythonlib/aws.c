...
static PyObject *method_aws_crt_crc32c(PyObject *self, PyObject *args) {
    (void)self;
    (void)args;
    ...
    /* Parse arguments */
    if (!PyArg_ParseTuple(args, "y*nI", &a, &b, &c)) {
        printf("method_aws_crt_crc32c parsing error\n");
        return NULL;
    }
    const uint8_t * d = (const uint8_t *) a.buf;
    uint32_t ret = aws_crt_crc32c(d, b, c);
    PyBuffer_Release(&a);
...
static PyObject *method_aws_crt_mem_dump(PyObject *self, PyObject *args) {
    (void)self;
    (void)args;
...
static PyObject *method_aws_crt_mem_bytes(PyObject *self, PyObject *args) {
    (void)self;
    (void)args;
    
    uint64_t ret = aws_crt_mem_bytes();
    return PyLong_FromUnsignedLong(ret);
}
...
static PyObject *method_aws_crt_mem_count(PyObject *self, PyObject *args) {
    (void)self;
    (void)args;
    
    uint64_t ret = aws_crt_mem_count();
    return PyLong_FromUnsignedLong(ret);
}
...
static PyObject *method_aws_crt_crc32(PyObject *self, PyObject *args) {
    (void)self;
    (void)args;
    ...
    /* Parse arguments */
    if (!PyArg_ParseTuple(args, "y*nI", &a, &b, &c)) {
        printf("method_aws_crt_crc32 parsing error\n");
        return NULL;
    }
    const uint8_t * d = (const uint8_t *) a.buf;
    uint32_t ret = aws_crt_crc32(d, b, c);
    PyBuffer_Release(&a);
    return PyLong_FromUnsignedLong(ret);
}
...
static PyMethodDef aws_methods[] = {
    ...
    {"aws_crt_crc32c", method_aws_crt_crc32c, METH_VARARGS, ""},
    ...
    {"aws_crt_mem_dump", method_aws_crt_mem_dump, METH_VARARGS, ""},
    ...
    {"aws_crt_mem_bytes", method_aws_crt_mem_bytes, METH_VARARGS, ""},
    {"aws_crt_test_error", method_aws_crt_test_error, METH_VARARGS, ""},
    {"aws_crt_mem_count", method_aws_crt_mem_count, METH_VARARGS, ""},
    ...
    {"aws_crt_crc32", method_aws_crt_crc32, METH_VARARGS, ""},

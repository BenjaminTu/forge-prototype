...
JNIEXPORT jlong JNICALL Java_AWS_awsCrtCrc32c(JNIEnv *env, jobject obj, jbyteArray a, jint b, jlong c) {
    (void)env;
    (void)obj;
    
    const uint8_t * d = (const uint8_t *) (*env)->GetByteArrayElements(env, a, 0);
    return aws_crt_crc32c(d, b, c);
}
...
JNIEXPORT void JNICALL Java_AWS_awsCrtMemDump(JNIEnv *env, jobject obj) {
    (void)env;
    (void)obj;
...
JNIEXPORT jlong JNICALL Java_AWS_awsCrtMemBytes(JNIEnv *env, jobject obj) {
    (void)env;
    (void)obj;
    
    return aws_crt_mem_bytes();
}
...
JNIEXPORT jlong JNICALL Java_AWS_awsCrtMemCount(JNIEnv *env, jobject obj) {
    (void)env;
    (void)obj;
    
    return aws_crt_mem_count();
}
...
JNIEXPORT jlong JNICALL Java_AWS_awsCrtCrc32(JNIEnv *env, jobject obj, jbyteArray a, jint b, jlong c) {
    (void)env;
    (void)obj;
    
    const uint8_t * d = (const uint8_t *) (*env)->GetByteArrayElements(env, a, 0);
    return aws_crt_crc32(d, b, c);
}

...
static PyObject *method_aws_crt_http_message_new_from_blob(PyObject *self, PyObject *args) {
    ...
    /* Parse arguments */
    if (!PyArg_ParseTuple(args, "sn", &a, &b)) {
        return NULL;
    }
    PyObject *ret = PyCapsule_New((void *)aws_crt_http_message_new_from_blob(a, b), "aws_crt_http_message *", NULL);
    return (ret);
}
...
static PyObject *method_aws_crt_http_headers_new_from_blob(PyObject *self, PyObject *args) {
    ...
    PyObject *ret = PyCapsule_New((void *)aws_crt_http_headers_new_from_blob(a, b), "aws_crt_http_headers *", NULL);
    return (ret);
}
